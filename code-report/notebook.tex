...
{\color{incolor}In [{\color{incolor}6}]:} \PY{c+c1}{\PYZsh{} ATTENTION: To show results, from the menu bar please click \PYZdq{}Cell \PYZgt{} Run All\PYZdq{}}
        \PY{o}{\PYZpc{}}\PY{k}{run} CountySnapshots.ipynb
\end{Verbatim}
...
<IPython.core.display.HTML object>
    ...
    \begin{verbatim}
HBox(children=(VBox(children=(Dropdown(description='County:', options=('Albany', 'Sheridan', 'Carbon', 'Larami…
    \end{verbatim}
...
HBox(children=(VBox(children=(VBox(children=(HTML(value='<h2>County Arrest Rates</h2>'), HBox(children=(Output…
    ...
    \begin{verbatim}
HTML(value='<hr><h2>DFS Placements</h2>')
    \end{verbatim}

    
    
    \begin{verbatim}
HTML(value='The left table depicts placement type (of those in care), by Judicial District.                  J…
    \end{verbatim}

    
    
    \begin{verbatim}
HBox(children=(VBox(children=(Output(), HTML(value='SOURCE: placements footer'))), VBox(children=(VBox(childre…
    \end{verbatim}
